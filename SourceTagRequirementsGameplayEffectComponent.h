...
#include "SourceTagRequirementsGameplayEffectComponent.generated.h"

/** Specifies tag requirements that the Source (Source/applier of the Gameplay Effect) must have if this GE should apply or continue to execute */
UCLASS()
class LEWDUS_API USourceTagRequirementsGameplayEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()
	
public:
	/** Constructor to set EditorFriendlyName */
	USourceTagRequirementsGameplayEffectComponent();
...
public:
	/** Tag requirements the source must have for this GameplayEffect to be applied. This is pass/fail at the time of application. If fail, this GE fails to apply. */
